...
# sigs
Simple thread-safe signal/slot C++20 library, which is templated and include-only. No linking required. Just include the header file "*sigs.h*" (C++17 version in "*sigs17.h*").
